/*
 * Scripting Reference Online Document:
 *
 * https://theiviaxx.github.io/photoshop-docs/scripting.html
 *
 * */
...
/****************************************/
// DO NOT REMOVE: prototype-function for array indexOf method, which is not supported in ExtendedScript
...
/* NOTES:
 *
 * palette window is non-modal, which lets user interact either with the window itself
 * and with the host program
 *
 * (contrary to palette, another window type 'dialogs' doesn't support interacting with
 * the host program)
 *
 * palette window is useful here since user could select layers for exporting while 
 * the script is running. Unfortunally, palette, even though supported in Photoshop,
 * is not fully functioning. As asserted in ScriptUI for Dummies guide by Peter Kahrel
 *
...
/*
*   NOTE:
*   - uncomment android onClick listerner would block display of Progress Bar contents,
